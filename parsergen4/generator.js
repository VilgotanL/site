...
function parse(code, { start: startDefName = "main", filename: filename = null, custom_defs = null } = {}) {
	...
	define("comment", null, exprs.join(exprs.str("#"), exprs.repeat(exprs.join(exprs.not(exprs.str("\n")), exprs.char_range("\x00", "\xFF"))), exprs.optional(exprs.str("\n"))));
	...
	define("identifier", null, exprs.join(exprs.choice(exprs.char_range("a", "z"), exprs.char_range("A", "Z"), exprs.str("_")), exprs.repeat(exprs.choice(exprs.char_range("a", "z"), exprs.char_range("A", "Z"), exprs.char_range("0", "9"), exprs.str("_")))));
	define("string", null, exprs.join(exprs.emit_code("\""), exprs.choice(exprs.join(exprs.str("\""), exprs.repeat(exprs.join(exprs.not(exprs.str("\"")), exprs.not(exprs.str("\n")), exprs.def("char"))), exprs.str("\"")), exprs.join(exprs.str("\'"), exprs.repeat(exprs.join(exprs.not(exprs.str("\'")), exprs.not(exprs.str("\n")), exprs.def("char"))), exprs.str("\'"))), exprs.emit_code("\"")));
	...
	define("statement", null, exprs.join(exprs.emit_code("\	define(\""), exprs.emit_consumed(exprs.def("identifier")), exprs.emit_code("\", "), exprs.choice(exprs.join(exprs.def("_"), exprs.str(":"), exprs.def("_"), exprs.def("string"), exprs.emit_code(", ")), exprs.emit_code("null, ")), exprs.def("_"), exprs.str("="), exprs.def("_"), exprs.def("expr"), exprs.emit_code(");\n")));
	define("expr", null, exprs.def("expr1"));
